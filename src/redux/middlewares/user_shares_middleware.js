...
export const userSharesMiddleware = (params) => {
    return async (dispatch) => {
        dispatch({ type: Actions.GET_SHARES_LOADING });
        ...
        fialureOrData.result == ProcessResult.SUCCESS ?
            dispatch({ type: Actions.GET_SHARES_SUCCESS, payload: { items: fialureOrData.response.data } }) :
            dispatch({ type: Actions.GET_SHARES_FAILURE, payload: { failure: fialureOrData.failure } });
