...
export const userSavesMiddleware = (params) => {
    return async (dispatch) => {
        dispatch({ type: Actions.GET_SAVES_LOADING });
        ...
        fialureOrData.result == ProcessResult.SUCCESS ?
            dispatch({ type: Actions.GET_SAVES_SUCCESS, payload: { items: fialureOrData.response.data } }) :
            dispatch({ type: Actions.GET_SAVES_FAILURE, payload: { failure: fialureOrData.failure } });
