...
export const userChannelsMiddleware = (params) => {
    return async (dispatch) => {
        dispatch({ type: Actions.GET_CHANNELS_LOADING });
        ...
        fialureOrData.result == ProcessResult.SUCCESS ?
            dispatch({ type: Actions.GET_CHANNELS_SUCCESS, payload: { items: fialureOrData.response.data } }) :
            dispatch({ type: Actions.GET_CHANNELS_FAILURE, payload: { failure: fialureOrData.failure } });
